...
public class DynamicProxyFilterConfig {
    ...
    public OrderRepositoryV1 orderRepositoryV1(LogTrace logTrace) {
        LogTraceFilterHandler handler = new LogTraceFilterHandler(new OrderRepositoryV1Impl(), logTrace, PATTERNS);
    ...
    public OrderServiceV1 orderServiceV11(LogTrace logTrace) {
        LogTraceFilterHandler handler = new LogTraceFilterHandler(new OrderServiceImpl(orderRepositoryV1(logTrace)), logTrace, PATTERNS);
    ...
    public OrderControllerV1 orderControllerV11(LogTrace logTrace) {
        LogTraceFilterHandler handler = new LogTraceFilterHandler(new OrderControllerV1Impl(orderServiceV11(logTrace)), logTrace, PATTERNS);
